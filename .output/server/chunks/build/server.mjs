import { hasInjectionContext, inject, version, h, defineComponent, ref, provide, createElementBlock, defineAsyncComponent, shallowReactive, watch, Suspense, nextTick, Transition, unref, getCurrentInstance, computed, resolveComponent, useSSRContext, createApp, effectScope, reactive, markRaw, isRef, isReactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, getCurrentScope, onScopeDispose, shallowRef, isReadonly, toRefs, mergeProps, withCtx, createTextVNode, isShallow } from 'vue';
import { $ as $fetch, l as defu, m as hasProtocol, n as joinURL, p as parseURL, o as parseQuery, q as encodeParam, r as createHooks, h as createError$1, w as withQuery, t as isScriptProtocol, v as withTrailingSlash, x as withoutTrailingSlash, y as sanitizeStatusCode, z as isSamePath, A as toRouteMatcher, B as createRouter$1, C as withLeadingSlash, D as encodePath } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BEUHK9HG.mjs').then((m) => m.default || m)
  },
  {
    name: "play",
    path: "/play",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./play-0k8bXNhO.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-C5z3Olv_.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-Xu7Zr3JU.mjs').then((r) => r["default"] || r.default || r));
...
const imgixRuntime$zuRSIkilPZ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage: getImage$1,
...
const ipxRuntime$wPdN1vrL65 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["imgix"]: { provider: imgixRuntime$zuRSIkilPZ, defaults: { "baseURL": "https://images.unsplash.com/" } },
  ["ipx"]: { provider: ipxRuntime$wPdN1vrL65, defaults: {} }
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "grid min-h-full place-items-center bg-white py-24 px-6 sm:py-32 lg:px-8" }, _attrs))}><div class="text-center"><p class="text-base font-semibold text-indigo-600"> 404 </p><h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl"> Page not found </h1><p class="mt-6 text-base leading-7 text-gray-600"> Sorry, we couldn’t find the page you’re looking for. </p><div class="mt-10 flex items-center justify-center gap-x-6">`);
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, appLayoutTransition as a, _wrapIf as b, useNuxtApp as c, defineStore as d, entry$1 as default, __nuxt_component_0$1 as e, useRoute as u };
